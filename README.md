...
## 自宅テスト
飛行はしていません。4機のタイニーを使用してTinyViewPlusに4画面表示したものをモニターしながらのテスト。
最初に3次合成の計算で最悪の結果が出た"R2 5695, A8 5725, B4 5790, F5 5820"にてB4が完全にブラックアウトする事象を確認。問題の出し方も確認。

次に上でリストした組み合わせを順次テスト。結論だけを書くと"(E1)5705[LED2], (A8)5725[LED3], (A5)5785[LED4], (F5)5820[LED6]"の組み合わせがいちばん良かったです。E1がかなりチカチカします。機体の個体差も考え得るのでE1の機体を他のチャネルと入れ替えてみましたが結果は同じでした。

(E2)5685[LED2], (E1)5705[LED2], (F3)5780[LED4], (F5)5820[LED6]も同じくらいには良かったです。この組み合わせの場合はF3がチラつきました。

チャネルにより不公平が出ると判断するとレース向きではないのかも知れません。
